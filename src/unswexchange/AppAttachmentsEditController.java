 ...
 * @author ismmedina
 */
public class AppAttachmentsEditController implements Initializable {
    ...
    public AppAttachmentsEditController() {
    ...
    private void nextButtonAction(ActionEvent event) throws IOException, ClassNotFoundException, SQLException {
        ...
        files.add(creditPdf);
        fileLogic.updateFiles(files);

        Alert alert = new Alert(Alert.AlertType.INFORMATION);
        alert.setTitle("Information Dialog");
        alert.setHeaderText(null);
        alert.setContentText("Files have been updated");
        alert.show();
