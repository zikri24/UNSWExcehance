 ...
 * @author ismmedina
 */
public class OfficerApplicationDecisionDeclineController implements Initializable {
    ...
    public OfficerApplicationDecisionDeclineController() {
    ...
    private void submitButtonPressed(ActionEvent event) throws IOException, ClassNotFoundException, SQLException {
        ...
        int feedback;
        feedback = appLogic.declineApplication(applicationId,comments);
        if (feedback > 0) {
             Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("Information Dialog");
            alert.setHeaderText(null);
            alert.setContentText("Application has been Declined");
            alert.show();
